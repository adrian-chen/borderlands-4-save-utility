    ...
    <div className="app">
      <header>
        ...
        <nav className="header-nav">
          ...
          <Link to="/steam-id">How to Find Steam ID</Link>
          <Link to="/save-location">How to Find Save Files</Link>
        </nav>
      </header>
        ...
        <div className="app-container">
          <div className="main-content">
            <div className="info-section">
              ...
              <ol>
                <li>Enter your Steam ID (17 digits) - <Link to="/steam-id">Need help?</Link></li>
                <li>Select your .sav file (1.sav, 2.sav, etc.) - <Link to="/save-location">Where?</Link></li>
                <li>Optional: Check "Decode item serials" to edit weapon stats</li>
              ...
              <ol>
                ...
                <li>If you decoded item serials, edit the _DECODED_ITEMS section to modify weapon stats (damage, rarity, manufacturer)</li>
              </ol>

              <h3>Step 3: Encrypt Back to .sav</h3>
              <ol>
                <li>After editing, click the "Encrypt This" button in the editor header</li>
                <li>If you edited _DECODED_ITEMS, make sure "Apply item serial changes" is checked</li>
              ...
              <ul>
                ...
                <li><strong>Item Serial Editing:</strong> Only "high confidence" items in _DECODED_ITEMS are recommended for editing</li>
              </ul>
